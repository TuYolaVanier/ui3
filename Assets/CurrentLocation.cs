...
public class CurrentLocation : MonoBehaviour
{
	...
	public Text Selected_CRoom;
	public Text Confirmed_CRoom;

	public void Dropdown_IndexChanged1(int index)
	{
		Selected_CRoom.text = Floor_1 [index];
	}

	public void Dropdown_IndexChanged2(int index)
	{
		Selected_CRoom.text = Floor_2 [index];
	}

	public void Dropdown_IndexChanged3(int index)
	{
		Selected_CRoom.text = Floor_3 [index];
	}
	...
	{
		Confirmed_CRoom.text = Selected_CRoom.text;
	...
	{
		Selected_CRoom.text = button_location;
	}
}